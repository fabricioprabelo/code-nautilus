...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/code-nautilus.py https://raw.githubusercontent.com/fabricioprabelo/code-nautilus/master/code-nautilus.py
